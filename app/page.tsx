...
context: <all the contextual information>`}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mt-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {/* LinkedIn */}
            <Link
              href="https://www.linkedin.com/in/abishkar-dhenga/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* WhatsApp */}
            <Link
              href="https://wa.me/9779827505260"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <Link
              href="https://www.instagram.com/aabiskardhenga/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-gradient-to-br from-purple-600 to-pink-500 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-600 transition-colors"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
